...
public class ItemDAOSQLite implements IItemDAO {
    ...
    public ItemDAOSQLite(IGerenciarConexaoStrategy gerenciarConexao) {
    ...
    public void criarTabela() throws SQLException {
        String sql = "CREATE TABLE IF NOT EXISTS ITENS (" +
                ...
                "id_circular TEXT UNIQUE NOT NULL," +
    ...
    private void setStatementFromDTO(PreparedStatement pstmt, ItemDTO item) throws SQLException {
        ...
        pstmt.setInt(16, item.isVendido() ? 1 : 0);
    }
}